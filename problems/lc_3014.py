...
# Example 2: Input: word = "xycdefghij" Output: 12 Explanation: The remapped keypad given in the image provides the minimum cost.
# "x" -> one push on key 2
...
# It can be shown that no other mapping can provide a lower cost.
# Constraints: 1 <= word.length <= 26 word consists of lowercase English letters.
