...
# Example 1: Input: s = "letsleetcode", k = 2 Output: "let" Explanation: There are two longest subsequences repeated 2 times: "let" and "ete".
# "let" is the lexicographically largest one.
# Example 2: Input: s = "bb", k = 2 Output: "b" Explanation: The longest subsequence repeated 2 times is "b".
# Example 3: Input: s = "ab", k = 2 Output: "" Explanation: There is no subsequence repeated 2 times.
# Empty string is returned.
# Constraints: n == s.length 2 <= n, k <= 2000 2 <= n < k * 8 s consists of lowercase English letters.
