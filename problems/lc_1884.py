...
# Example 1: Input: n = 2 Output: 2 Explanation: We can drop the first egg from floor 1 and the second egg from floor 2.
# If the first egg breaks, we know that f = 0.
# If the second egg breaks but the first egg didn't, we know that f = 1.
# Otherwise, if both eggs survive, we know that f = 2.
# Example 2: Input: n = 100 Output: 14 Explanation: One optimal strategy is:
# - Drop the 1st egg at floor 9.
# If it breaks, we know f is between 0 and 8.
