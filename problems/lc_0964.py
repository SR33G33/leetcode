...
# When writing such an expression, we adhere to the following conventions: The division operator ( / ) returns rational numbers.
...
# Example 1: Input: x = 3, target = 19 Output: 5 Explanation: 3 * 3 + 3 * 3 + 3 / 3.
# The expression contains 5 operations.
# Example 2: Input: x = 5, target = 501 Output: 8 Explanation: 5 * 5 * 5 * 5 - 5 * 5 * 5 + 5 / 5.
# The expression contains 8 operations.
# Example 3: Input: x = 100, target = 100000000 Output: 3 Explanation: 100 * 100 * 100 * 100.
