...
# Write a solution to: Find users who converted from free trial to paid subscription Calculate each user's average daily activity duration during their free trial period (rounded to 2 decimal places) Calculate each user's average daily activity duration during their paid subscription period (rounded to 2 decimal places) Return the result table ordered by user_id in ascending order .
# The result format is in the following example.
# Example: Input: UserActivity table: +---------+---------------+---------------+-------------------+
...
# | 3       | 70.00              | 63.33             |
# | 4       | 37.50              | 45.00             |
# +---------+--------------------+-------------------+ Explanation: User 1: Had 3 days of free trial with durations of 45, 30, and 60 minutes.
...
# User 2: Had 3 days of free trial with durations of 55, 25, and 50 minutes.
...
# User 3: Had 3 days of free trial with durations of 70, 60, and 80 minutes.
...
# User 4: Had 2 days of free trial with durations of 40 and 35 minutes.
...
class Solution:
    def analyzeSubscriptionConversion(self) -> Any:
      return
