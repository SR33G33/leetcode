...
# Example 1: Input: queries = [[1,2],[2,4]] Output: 3 Explanation: For queries[0] : The initial array is nums = [1, 2] .
# In the first operation, select nums[0] and nums[1] .
# The array becomes [0, 0] .
# The minimum number of operations required is 1.
# For queries[1] : The initial array is nums = [2, 3, 4] .
...
# The output is 1 + 2 = 3 .
# Example 2: Input: queries = [[2,6]] Output: 4 Explanation: For queries[0] : The initial array is nums = [2, 3, 4, 5, 6] .
...
# The output is 4.
# Constraints: 1 <= queries.length <= 10 5 queries[i].length == 2 queries[i] == [l, r] 1 <= l < r <= 10 9
