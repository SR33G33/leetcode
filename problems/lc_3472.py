...
# Example 1: Input: s = "abced", k = 2 Output: 3 Explanation: Replace s[1] with the next letter, and s becomes "acced" .
# Replace s[4] with the previous letter, and s becomes "accec" .
# The subsequence "ccc" forms a palindrome of length 3, which is the maximum.
# Example 2: Input: s = " aaazzz ", k = 4 Output: 6 Explanation: Replace s[0] with the previous letter, and s becomes "zaazzz" .
# Replace s[4] with the next letter, and s becomes "zaazaz" .
# Replace s[3] with the next letter, and s becomes "zaaaaz" .
# The entire string forms a palindrome of length 6.
# Constraints: 1 <= s.length <= 200 1 <= k <= 200 s consists of only lowercase English letters.
