...
# Example 1: Input: s = "1234" Output: false Explanation: There is no valid way to split s.
# Example 2: Input: s = "050043" Output: true Explanation: s can be split into ["05", "004", "3"] with numerical values [5,4,3].
# The values are in descending order with adjacent values differing by 1.
# Example 3: Input: s = "9080701" Output: false Explanation: There is no valid way to split s.
# Constraints: 1 <= s.length <= 20 s only consists of digits.
