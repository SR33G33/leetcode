...
# Consider an array nums ( 1-indexed ) that consists of the integers in the inclusive range [1, 2 p - 1] in their binary representations.
...
# Example 1: Input: p = 1 Output: 1 Explanation: nums = [1].
# There is only one element, so the product equals that element.
# Example 2: Input: p = 2 Output: 6 Explanation: nums = [01, 10, 11].
# Any swap would either make the product 0 or stay the same.
# Thus, the array product of 1 * 2 * 3 = 6 is already minimized.
# Example 3: Input: p = 3 Output: 1512 Explanation: nums = [001, 010, 011, 100, 101, 110, 111]
