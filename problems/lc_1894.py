...
# Example 1: Input: chalk = [5,1,5], k = 22 Output: 0 Explanation: The students go in turns as follows:
...
# Example 2: Input: chalk = [3,4,1,2], k = 25 Output: 1 Explanation: The students go in turns as follows:
