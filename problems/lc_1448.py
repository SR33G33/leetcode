...
# Example 1: Input: root = [3,1,4,3,null,1,5] Output: 4 Explanation: Nodes in blue are good .
...
# Example 3: Input: root = [1] Output: 1 Explanation: Root is considered as good .
