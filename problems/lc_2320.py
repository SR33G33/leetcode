...
# Example 1: Input: n = 1 Output: 4 Explanation: Possible arrangements:
# 1.
# All plots are empty.
# 2.
...
# Example 2: Input: n = 2 Output: 9 Explanation: The 9 possible arrangements are shown in the diagram above.
