...
# You are given a 0-indexed binary string s which represents the types of buildings along a street where: s[i] = '0' denotes that the i th building is an office and s[i] = '1' denotes that the i th building is a restaurant.
...
# Example 1: Input: s = "001101" Output: 6 Explanation: The following sets of indices selected are valid:
...
# Thus, there are 6 total ways.
# Example 2: Input: s = "11100" Output: 0 Explanation: It can be shown that there are no valid selections.
