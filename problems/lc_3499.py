...
# Example 1: Input: s = "01" Output: 1 Explanation: Because there is no block of '1' s surrounded by '0' s, no valid trade is possible.
# The maximum number of active sections is 1.
# Example 2: Input: s = "0100" Output: 4 Explanation: String "0100" → Augmented to "101001" .
...
# Example 3: Input: s = "1000100" Output: 7 Explanation: String "1000100" → Augmented to "110001001" .
...
# Example 4: Input: s = "01010" Output: 4 Explanation: String "01010" → Augmented to "1010101" .
