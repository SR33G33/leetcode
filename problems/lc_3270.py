...
# The key of num1 , num2 , and num3 is defined as a four-digit number such that: Initially, if any number has less than four digits, it is padded with leading zeros .
...
# Example 3: Input: num1 = 1, num2 = 2, num3 = 3 Output: 1 Constraints: 1 <= num1, num2, num3 <= 9999
