...
# Example 1: Input: num = "327" Output: 2 Explanation: You could have written down the numbers:
# 3, 27
# 327
# Example 2: Input: num = "094" Output: 0 Explanation: No numbers can have leading zeros and all numbers must be positive.
# Example 3: Input: num = "0" Output: 0 Explanation: No numbers can have leading zeros and all numbers must be positive.
# Constraints: 1 <= num.length <= 3500 num consists of digits '0' through '9' .
