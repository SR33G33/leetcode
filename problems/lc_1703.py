...
# Example 1: Input: nums = [1,0,0,1,0,1], k = 2 Output: 1 Explanation: In 1 move, nums could be [1,0,0,0, 1 , 1 ] and have 2 consecutive 1's.
...
# Example 3: Input: nums = [1,1,0,1], k = 2 Output: 0 Explanation: nums already has 2 consecutive 1's.
# Constraints: 1 <= nums.length <= 10 5 nums[i] is 0 or 1 . 1 <= k <= sum(nums)
