...
# Example 1: Input: s = "ababccc" Output: 5 Explanation : One way to split maximally is ['a', 'b', 'ab', 'c', 'cc'].
...
# Example 3: Input: s = "aa" Output: 1 Explanation : It is impossible to split the string any further.
# Constraints: 1 <= s.length <= 16 s contains only lower case English letters.
