...
# You can rotate it by a non-negative integer k so that the array becomes [nums[k], nums[k + 1], ... nums[nums.length - 1], nums[0], nums[1], ..., nums[k-1]] .
...
# Example 1: Input: nums = [2,3,1,4,0] Output: 3 Explanation: Scores for each k are listed below:
...
# Example 2: Input: nums = [1,3,0,2,4] Output: 0 Explanation: nums will always have 3 points no matter how it shifts.
