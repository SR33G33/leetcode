...
# Example 1: Input: k = 5, operations = [0,0,0] Output: "a" Explanation: Initially, word == "a" .
# Alice performs the three operations as follows: Appends "a" to "a" , word becomes "aa" .
# Appends "aa" to "aa" , word becomes "aaaa" .
# Appends "aaaa" to "aaaa" , word becomes "aaaaaaaa" .
# Example 2: Input: k = 10, operations = [0,1,0,1] Output: "b" Explanation: Initially, word == "a" .
# Alice performs the four operations as follows: Appends "a" to "a" , word becomes "aa" .
# Appends "bb" to "aa" , word becomes "aabb" .
# Appends "aabb" to "aabb" , word becomes "aabbaabb" .
# Appends "bbccbbcc" to "aabbaabb" , word becomes "aabbaabbbbccbbcc" .
# Constraints: 1 <= k <= 10 14 1 <= operations.length <= 100 operations[i] is either 0 or 1.
