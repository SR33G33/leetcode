...
# Example 1: Input: moves = "UD" Output: true Explanation : The robot moves up once, and then down once.
# All moves have the same magnitude, so it ended up at the origin where it started.
# Therefore, we return true.
# Example 2: Input: moves = "LL" Output: false Explanation : The robot moves left twice.
