...
# Example 1: Input: n = 4, time = 5 Output: 2 Explanation: People pass the pillow in the following way: 1 -> 2 -> 3 -> 4 -> 3 -> 2.
# After five seconds, the 2 nd person is holding the pillow.
# Example 2: Input: n = 3, time = 2 Output: 3 Explanation: People pass the pillow in the following way: 1 -> 2 -> 3.
# After two seconds, the 3 r d person is holding the pillow.
# Constraints: 2 <= n <= 1000 1 <= time <= 1000 Note: This question is the same as 3178: Find the Child Who Has the Ball After K Seconds.
