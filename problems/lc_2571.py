...
# Example 1: Input: n = 39 Output: 3 Explanation: We can do the following operations:
# - Add 2 0 = 1 to n, so now n = 40.
# - Subtract 2 3 = 8 from n, so now n = 32.
# - Subtract 2 5 = 32 from n, so now n = 0.
# It can be shown that 3 is the minimum number of operations we need to make n equal to 0.
# Example 2: Input: n = 54 Output: 3 Explanation: We can do the following operations:
