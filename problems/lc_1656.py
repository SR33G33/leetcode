...
# Example: Input ["OrderedStream", "insert", "insert", "insert", "insert", "insert"]
...
# Constraints: 1 <= n <= 1000 1 <= id <= n value.length == 5 value consists only of lowercase letters.
...
# obj = OrderedStream(n)
# param_1 = obj.insert(idKey,value)return
