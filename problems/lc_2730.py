...
# Example 1: Input: s = "52233" Output: 4 Explanation: The longest semi-repetitive substring is "5223".
# Picking the whole string "52233" has two adjacent same digit pairs 22 and 33, but at most one is allowed.
# Example 2: Input: s = "5494" Output: 4 Explanation: s is a semi-repetitive string.
# Example 3: Input: s = "1111111" Output: 2 Explanation: The longest semi-repetitive substring is "11".
# Picking the substring "111" has two adjacent same digit pairs, but at most one is allowed.
