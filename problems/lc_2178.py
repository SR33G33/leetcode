...
# Example 1: Input: finalSum = 12 Output: [2,4,6] Explanation: The following are valid splits: (12) , (2 + 10) , (2 + 4 + 6) , and (4 + 8) .
# (2 + 4 + 6) has the maximum number of integers, which is 3.
# Thus, we return [2,4,6].
# Note that [2,6,4], [6,2,4], etc. are also accepted.
# Example 2: Input: finalSum = 7 Output: [] Explanation: There are no valid splits for the given finalSum.
# Thus, we return an empty array.
# Example 3: Input: finalSum = 28 Output: [6,8,2,12] Explanation: The following are valid splits: (2 + 26) , (6 + 8 + 2 + 12) , and (4 + 24) . (6 + 8 + 2 + 12) has the maximum number of integers, which is 4.
