...
# Example 1: Input: prices = [1,2,2], money = 3 Output: 0 Explanation: Purchase the chocolates priced at 1 and 2 units respectively.
...
# Constraints: 2 <= prices.length <= 50 1 <= prices[i] <= 100 1 <= money <= 100
