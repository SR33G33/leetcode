...
# Given an integer n , you must transform it into 0 using the following operations any number of times: Change the rightmost ( 0 th ) bit in the binary representation of n .
...
# Example 1: Input: n = 3 Output: 2 Explanation: The binary representation of 3 is "11".
# " 1 1" -> " 0 1" with the 2 nd operation since the 0 th bit is 1.
# "0 1 " -> "0 0 " with the 1 st operation.
# Example 2: Input: n = 6 Output: 4 Explanation: The binary representation of 6 is "110".
