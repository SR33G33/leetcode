...
# A book is considered currently borrowed if there exists a borrowing record with a NULL return_date Return the result table ordered by current borrowers in descending order, then by book title in ascending order.
# The result format is in the following example.
# Example: Input: library_books table: +---------+------------------------+------------------+----------+------------------+--------------+
# | book_id | title                  | author           | genre    | publication_year | total_copies |
# +---------+------------------------+------------------+----------+------------------+--------------+
# | 1       | The Great Gatsby       | F.
# Scott         | Fiction  | 1925             | 3            |
# | 2       | To Kill a Mockingbird  | Harper Lee       | Fiction  | 1960             | 3            |
# | 3       | 1984                   | George Orwell    | Dystopian| 1949             | 1            |
# | 4       | Pride and Prejudice    | Jane Austen      | Romance  | 1813             | 2            |
# | 5       | The Catcher in the Rye | J.D.
# Salinger    | Fiction  | 1951             | 1            |
