...
# The strings are labeled from 1 to n , where the string with length i is labeled s i .
...
# Example 1: Input: s = "babab" Output: 9 Explanation: For s 1 == "b", the longest common prefix is "b" which has a score of 1.
...
# Example 2: Input: s = "azbazbzaz" Output: 14 Explanation: For s 2 == "az", the longest common prefix is "az" which has a score of 2.
