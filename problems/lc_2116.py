...
# Example 1: Input: s = "))()))", locked = "010100" Output: true Explanation: locked[1] == '1' and locked[3] == '1', so we cannot change s[1] or s[3].
...
# Example 3: Input: s = ")", locked = "0" Output: false Explanation: locked permits us to change s[0].
# Changing s[0] to either '(' or ')' will not make s valid.
# Example 4: Input: s = "(((())(((())", locked = "111111010111" Output: true Explanation: locked permits us to change s[6] and s[8].
# We change s[6] and s[8] to ')' to make s valid.
# Constraints: n == s.length == locked.length 1 <= n <= 10 5 s[i] is either '(' or ')' . locked[i] is either '0' or '1' .
