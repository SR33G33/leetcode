...
# Here are the rules of Tic-Tac-Toe: Players take turns placing characters into empty squares ' ' .
...
# Example 3: Input: board = ["XOX","O O","XOX"] Output: true Constraints: board.length == 3 board[i].length == 3 board[i][j] is either 'X' , 'O' , or ' ' .
