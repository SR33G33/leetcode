...
# Example 1: Input: cookies = [8,15,10,20,8], k = 2 Output: 31 Explanation: One optimal distribution is [8,15,8] and [10,20]
...
# Example 2: Input: cookies = [6,1,3,2,2,4,1,2], k = 3 Output: 7 Explanation: One optimal distribution is [6,1], [3,2,2], and [4,1,2]
...
# Constraints: 2 <= cookies.length <= 8 1 <= cookies[i] <= 10 5 2 <= k <= cookies.length
