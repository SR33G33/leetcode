...
# Example 3: Input: balls = [1,2,1,2] Output: 0.60000 Explanation: The set of balls is [1, 2, 2, 3, 4, 4].
# It is hard to display all the 180 possible random shuffles of this set but it is easy to check that 108 of them will have the same number of distinct colors in each box.
# Probability = 108 / 180 = 0.6 Constraints: 1 <= balls.length <= 8 1 <= balls[i] <= 6 sum(balls) is even.
