...
# Example 1: Input: a = 2, b = 4, c = 6 Output: 6 Explanation: The starting state is (2, 4, 6).
# One optimal set of moves is:
...
# Total: 6 points.
# Example 2: Input: a = 4, b = 4, c = 6 Output: 7 Explanation: The starting state is (4, 4, 6).
# One optimal set of moves is:
...
# There are fewer than two non-empty piles, so the game ends.
# Total: 7 points.
# Example 3: Input: a = 1, b = 8, c = 8 Output: 8 Explanation: One optimal set of moves is to take from the 2nd and 3rd piles for 8 turns until they are empty.
