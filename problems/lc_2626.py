...
# init = 0 Output: 10 Explanation: initially, the value is init=0.
# (0) + nums[0] = 1
# (1) + nums[1] = 3
# (3) + nums[2] = 6
# (6) + nums[3] = 10
...
# init = 100 Output: 130 Explanation: initially, the value is init=100.
...
# init = 25 Output: 25 Explanation: For empty arrays, the answer is always init.
