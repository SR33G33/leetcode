...
# Example 1: Input: s = "successes" Output: 6 Explanation: The vowels are: 'u' (frequency 1), 'e' (frequency 2).
# The maximum frequency is 2.
# The consonants are: 's' (frequency 4), 'c' (frequency 2).
# The maximum frequency is 4.
# The output is 2 + 4 = 6 .
# Example 2: Input: s = "aeiaeia" Output: 3 Explanation: The vowels are: 'a' (frequency 3), 'e' ( frequency 2), 'i' (frequency 2).
