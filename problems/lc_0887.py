...
# Example 1: Input: k = 1, n = 2 Output: 2 Explanation: Drop the egg from floor 1.
# If it breaks, we know that f = 0.
# Otherwise, drop the egg from floor 2.
# If it breaks, we know that f = 1.
# If it does not break, then we know f = 2.
# Hence, we need at minimum 2 moves to determine with certainty what the value of f is.
# Example 2: Input: k = 2, n = 6 Output: 3
# Example 3: Input: k = 3, n = 14 Output: 4 Constraints: 1 <= k <= 100 1 <= n <= 10 4
