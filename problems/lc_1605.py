...
# Example 1: Input: rowSum = [3,8], colSum = [4,7] Output: [[3,0],
...
# [3,5]]
# Example 2: Input: rowSum = [5,7,10], colSum = [8,6,8] Output: [[0,5,0],
# [6,1,0],
# [2,0,8]] Constraints: 1 <= rowSum.length, colSum.length <= 500 0 <= rowSum[i], colSum[i] <= 10 8 sum(rowSum) == sum(colSum)
