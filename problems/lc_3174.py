...
# Example 2: Input: s = "cb34" Output: "" Explanation: First, we apply the operation on s[2] , and s becomes "c4" .
# Then we apply the operation on s[1] , and s becomes "" .
# Constraints: 1 <= s.length <= 100 s consists only of lowercase English letters and digits.
