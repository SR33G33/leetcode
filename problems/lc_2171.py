...
# Example 1: Input: beans = [4,1,6,5] Output: 4 Explanation: - We remove 1 bean from the bag with only 1 bean.
...
# Example 2: Input: beans = [2,10,3,2] Output: 7 Explanation: - We remove 2 beans from one of the bags with 2 beans.
...
# Constraints: 1 <= beans.length <= 10 5 1 <= beans[i] <= 10 5
