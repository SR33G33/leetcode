...
# Example 1: Input: colors = "abaac", neededTime = [1,2,3,4,5] Output: 3 Explanation: In the above image, 'a' is blue, 'b' is red, and 'c' is green.
# Bob can remove the blue balloon at index 2.
# This takes 3 seconds.
# There are no longer two consecutive balloons of the same color.
# Total time = 3.
# Example 2: Input: colors = "abc", neededTime = [1,2,3] Output: 0 Explanation: The rope is already colorful.
# Bob does not need to remove any balloons from the rope.
# Example 3: Input: colors = "aabaa", neededTime = [1,2,3,4,1] Output: 2 Explanation: Bob will remove the balloons at indices 0 and 4.
