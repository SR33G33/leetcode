...
# You are given an array of events where events[i] = [startDay i , endDay i ] .
...
# Example 2: Input: events= [[1,2],[2,3],[3,4],[1,2]] Output: 4 Constraints: 1 <= events.length <= 10 5 events[i].length == 2 1 <= startDay i <= endDay i <= 10 5
