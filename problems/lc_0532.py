...
# Example 1: Input: nums = [3,1,4,1,5], k = 2 Output: 2 Explanation: There are two 2-diff pairs in the array, (1, 3) and (3, 5).
...
# Constraints: 1 <= nums.length <= 10 4 -10 7 <= nums[i] <= 10 7 0 <= k <= 10 7
