...
# Example 1: Input: edges = [2,2,3,-1], node1 = 0, node2 = 1 Output: 2 Explanation: The distance from node 0 to node 2 is 1, and the distance from node 1 to node 2 is 1.
...
# Example 2: Input: edges = [1,2,-1], node1 = 0, node2 = 2 Output: 2 Explanation: The distance from node 0 to node 2 is 2, and the distance from node 2 to itself is 0.
...
# Constraints: n == edges.length 2 <= n <= 10 5 -1 <= edges[i] < n edges[i] != i 0 <= node1, node2 < n
