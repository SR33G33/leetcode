...
# Note : A perfect binary tree is a tree where each node, except the leaf nodes, has exactly 2 children.
# The cost of a path is the sum of costs of nodes in the path.
# Example 1: Input: n = 7, cost = [1,5,2,2,3,3,1] Output: 6 Explanation: We can do the following increments:
...
# Example 2: Input: n = 3, cost = [5,3,3] Output: 0 Explanation: The two paths already have equal total costs, so no increments are needed.
# Constraints: 3 <= n <= 10 5 n + 1 is a power of 2 cost.length == n 1 <= cost[i] <= 10 4
