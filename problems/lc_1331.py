...
# The rank has the following rules: Rank is an integer starting from 1.
...
# Example 3: Input: arr = [37,12,28,9,100,56,80,5,12] Output: [5,3,4,2,8,6,7,1,3] Constraints: 0 <= arr.length <= 10 5 -10 9 <= arr[i] <= 10 9
