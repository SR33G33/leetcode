...
# You are also given an array points where each points[i] = [a i , b i ] represents that a point exists at (a i , b i ) .
...
# Example 1: Input: x = 3, y = 4, points = [[1,2],[3,1],[2,4],[2,3],[4,4]] Output: 2 Explanation: Of all the points, only [3,1], [2,4] and [4,4] are valid.
...
# Example 3: Input: x = 3, y = 4, points = [[2,3]] Output: -1 Explanation: There are no valid points.
# Constraints: 1 <= points.length <= 10 4 points[i].length == 2 1 <= x, y, a i , b i <= 10 4
