...
# Example 1: Input: n = 22 Output: 2 Explanation: 22 in binary is "10110".
...
# Example 2: Input: n = 8 Output: 0 Explanation: 8 in binary is "1000".
# There are not any adjacent pairs of 1's in the binary representation of 8, so we return 0.
# Example 3: Input: n = 5 Output: 2 Explanation: 5 in binary is "101".
