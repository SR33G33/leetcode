...
# Example 1: Input: x = 18 Output: 9 Explanation: The sum of digits of x is 9 . 18 is divisible by 9 .
# So 18 is a Harshad number and the answer is 9 .
# Example 2: Input: x = 23 Output: -1 Explanation: The sum of digits of x is 5 . 23 is not divisible by 5 .
