...
# Example 1: Input: n = 6 Output: 3 Explanation: The first 6 elements of magical string s is "122112" and it contains three 1's, so return 3.
# Example 2: Input: n = 1 Output: 1 Constraints: 1 <= n <= 10 5
