...
# In other words: If an oxygen thread arrives at the barrier when no hydrogen threads are present, it must wait for two hydrogen threads.
...
# Example 1: Input: water = "HOH" Output: "HHO" Explanation: "HOH" and "OHH" are also valid answers.
# Example 2: Input: water = "OOHHHH" Output: "HHOHHO" Explanation: "HOHHHO", "OHHHHO", "HHOHOH", "HOHHOH", "OHHHOH", "HHOOHH", "HOHOHH" and "OHHOHH" are also valid answers.
# Constraints: 3 * n == water.length 1 <= n <= 20 water[i] is either 'H' or 'O' .
