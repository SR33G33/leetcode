...
# Example 1: Input: s = "abba" Output: 2 Explanation: One possible string t could be "ba" .
# Example 2: Input: s = "cdef" Output: 4 Explanation: One possible string t could be "cdef" , notice that t can be equal to s .
# Example 2: Input: s = "abcbcacabbaccba" Output: 3 Constraints: 1 <= s.length <= 10 5 s consist only of lowercase English letters.
