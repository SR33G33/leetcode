...
# Example 1: Input: nums = [0,2] Output: 1 Explanation: Select the subarray [1,1] (which is [2] ), where the minimum non-negative integer is 2.
# Setting all occurrences of 2 to 0 results in [0,0] .
# Thus, the minimum number of operations required is 1.
# Example 2: Input: nums = [3,1,2,1] Output: 3 Explanation: Select subarray [1,3] (which is [1,2,1] ), where the minimum non-negative integer is 1.
...
# Example 3: Input: nums = [1,2,1,2,1,2] Output: 4 Explanation: Select subarray [0,5] (which is [1,2,1,2,1,2] ), where the minimum non-negative integer is 1.
...
# Constraints: 1 <= n == nums.length <= 10 5 0 <= nums[i] <= 10 5
