...
# Example 2: Input: s = "abb" Output: 2 Explanation: " a bb" -> " bb " -> "".
# Remove palindromic subsequence "a" then "bb".
# Example 3: Input: s = "baabb" Output: 2 Explanation: " baa b b " -> " b " -> "".
# Remove palindromic subsequence "baab" then "b".
# Constraints: 1 <= s.length <= 1000 s[i] is either 'a' or 'b' .
