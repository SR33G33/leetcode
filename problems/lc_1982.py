...
# Example 1: Input: n = 3, sums = [-3,-2,-1,0,0,1,2,3] Output: [1,2,-3] Explanation: [1,2,-3] is able to achieve the given subset sums:
# - []: sum is 0
# - [1]: sum is 1
# - [2]: sum is 2
# - [1,2]: sum is 3
...
# Example 3: Input: n = 4, sums = [0,0,5,5,4,-1,4,9,9,-1,4,3,4,8,3,8] Output: [0,-1,4,5] Explanation: [0,-1,4,5] is able to achieve the given subset sums.
# Constraints: 1 <= n <= 15 sums.length == 2 n -10 4 <= sums[i] <= 10 4
