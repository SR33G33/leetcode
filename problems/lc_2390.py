...
# Example 1: Input: s = "leet**cod*e" Output: "lecoe" Explanation: Performing the removals from left to right:
...
# Constraints: 1 <= s.length <= 10 5 s consists of lowercase English letters and stars * .
