...
# Example 1: Input: word = "aabbccdd", k = 7 Output: 5 Explanation: The possible strings are: "aabbccdd" , "aabbccd" , "aabbcdd" , "aabccdd" , and "abbccdd" .
# Example 2: Input: word = "aabbccdd", k = 8 Output: 1 Explanation: The only possible string is "aabbccdd" .
# Example 3: Input: word = "aaabbb", k = 3 Output: 8 Constraints: 1 <= word.length <= 5 * 10 5 word consists only of lowercase English letters. 1 <= k <= 2000
