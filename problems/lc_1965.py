...
# The information of an employee is missing if: The employee's name is missing, or The employee's salary is missing.
# Return the result table ordered by employee_id in ascending order .
# The result format is in the following example.
# Example 1: Input: Employees table:
# +-------------+----------+
# | employee_id | name     |
# +-------------+----------+
# | 2           | Crew     |
...
class Solution:
    def employeesWithMissingInformation(self) -> Any:
      return
