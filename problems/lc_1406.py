...
# Example 1: Input: stoneValue = [1,2,3,7] Output: "Bob" Explanation: Alice will always lose.
# Her best move will be to take three piles and the score become 6.
# Now the score of Bob is 7 and Bob wins.
# Example 2: Input: stoneValue = [1,2,3,-9] Output: "Alice" Explanation: Alice must choose all the three piles at the first move to win and leave Bob with negative score.
...
# Example 3: Input: stoneValue = [1,2,3,6] Output: "Tie" Explanation: Alice cannot win this game.
