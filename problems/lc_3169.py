...
# Example 1: Input: days = 10, meetings = [[5,7],[1,3],[9,10]] Output: 2 Explanation: There is no meeting scheduled on the 4 th and 8 th days.
# Example 2: Input: days = 5, meetings = [[2,4],[1,3]] Output: 1 Explanation: There is no meeting scheduled on the 5 th day.
# Example 3: Input: days = 6, meetings = [[1,6]] Output: 0 Explanation: Meetings are scheduled for all working days.
# Constraints: 1 <= days <= 10 9 1 <= meetings.length <= 10 5 meetings[i].length == 2 1 <= meetings[i][0] <= meetings[i][1] <= days
