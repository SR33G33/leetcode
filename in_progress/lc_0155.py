...
# Example 1: Input ["MinStack","push","push","push","getMin","pop","top","getMin"]
...
# minStack.getMin(); // return -2 Constraints: -2 31 <= val <= 2 31 - 1 Methods pop , top and getMin operations will always be called on non-empty stacks.
